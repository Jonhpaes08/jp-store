            ...
            <section class="featured section container" id="featured">
                ...
                <div class="featured__container grid">
                    <article class="featured__card">
                        ...
                        <img src="assets/img-jp-sport/camisa_palmeiras.svg" alt="" class="featured__img">

                        <div class="featured__data">
                            <h3 class="featured__title">Palmeiras 22/23</h3>
                            <span class="featured__price" >R$ 119,90</span>
                        </div>
                    ...
                    <article class="featured__card">
                        ...
                        <img src="assets/img-jp-sport/camisa_casal_brasil.svg" alt="" class="featured__img">

                        <div class="featured__data">
                            <h3 class="featured__title">Brasil edição especial 22</h3>
                            <span class="featured__price">R$ 119,90</span>
                        </div>
                    ...
                    <div class="swiper testimonial-swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="testimonial__card swiper-slide">
                                ...
                                <p class="testimonial__description">
                                    Essa loja é inspiradora e muito confiavel, as entregas são muito rápido e os tecidos são maravilhosos, essa semana eu mesmo comprei 5 peças de roupas estou muito viciada em fazer compras na <strong>#JpStore</strong>.
                                </p>
                            ...
                            <div class="testimonial__card swiper-slide">
                                ...
                                <p class="testimonial__description">
                                    Obrigado <strong>#JpStore</strong> por existir, graças a vocês agora tenho roupas adequadas para frequentar a academia.
                                </p>
